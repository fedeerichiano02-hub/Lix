...
class MainActivity : AppCompatActivity() {
    ...
    private fun buildUi() {
        ...
        chat.addView(greeting, ViewGroup.LayoutParams(-1, -2).apply { bottomMargin = dp(18) })
    ...
    private fun sendMessage() {
        ...
        chat.addView(answer, ViewGroup.LayoutParams(-1, -2).apply { bottomMargin = dp(10) })
    ...
    private fun addMessage(author: String, message: String) {
        ...
        chat.addView(bubble, ViewGroup.LayoutParams(-1, -2).apply {
            bottomMargin = dp(10)
        })
        scroll.post { scroll.fullScroll(View.FOCUS_DOWN) }
    }
